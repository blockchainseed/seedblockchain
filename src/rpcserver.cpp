...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SeedBlockChain server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "SeedBlockChain server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SeedBlockChain features */
        {"seedblockchain", "masternode", &masternode, true, true, false},
        {"seedblockchain", "listmasternodes", &listmasternodes, true, true, false},
        {"seedblockchain", "getmasternodecount", &getmasternodecount, true, true, false},
        {"seedblockchain", "masternodeconnect", &masternodeconnect, true, true, false},
        {"seedblockchain", "masternodecurrent", &masternodecurrent, true, true, false},
        {"seedblockchain", "masternodedebug", &masternodedebug, true, true, false},
        {"seedblockchain", "startmasternode", &startmasternode, true, true, false},
        {"seedblockchain", "createmasternodekey", &createmasternodekey, true, true, false},
        {"seedblockchain", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"seedblockchain", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"seedblockchain", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"seedblockchain", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"seedblockchain", "getmasternodescores", &getmasternodescores, true, true, false},
        {"seedblockchain", "mnbudget", &mnbudget, true, true, false},
        {"seedblockchain", "preparebudget", &preparebudget, true, true, false},
        {"seedblockchain", "submitbudget", &submitbudget, true, true, false},
        {"seedblockchain", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"seedblockchain", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"seedblockchain", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"seedblockchain", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"seedblockchain", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"seedblockchain", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"seedblockchain", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"seedblockchain", "checkbudgets", &checkbudgets, true, true, false},
        {"seedblockchain", "mnsync", &mnsync, true, true, false},
        {"seedblockchain", "spork", &spork, true, true, false},
        {"seedblockchain", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"seedblockchain", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use seedblockchaind, or the -server option to seedblockchain-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> seedblockchain-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5402/\n";
}
