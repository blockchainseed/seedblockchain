...
/** Utility functions used by the SeedBlockChain Qt UI.
 */
namespace GUIUtil
{
...
// Render SeedBlockChain addresses in monospace font
...
// Parse "seedblockchain:" URI into recipient object, return true on successful parsing
