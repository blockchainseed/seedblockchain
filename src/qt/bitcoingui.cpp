                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Seed Blockchain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SeedBlockChain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and seedblockchain: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Seed Blockchain Core"), this);
    aboutAction->setStatusTip(tr("Show information about Seed Blockchain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SeedBlockChain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SeedBlockChain addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SeedBlockChain addresses"));
    ...
    openAction->setStatusTip(tr("Open a SeedBlockChain: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Seed Blockchain Core help message to get a list with possible SeedBlockChain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Seed Blockchain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SeedBlockChain network", "", count));
}
...
{
    QString strTitle = tr("Seed Blockchain Core"); // default title
    ...
    // Append title to "SeedBlockChain - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
