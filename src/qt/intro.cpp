...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Seed Blockchain Core"),
     ...
     * override -datadir in the seedblockchain.conf file in the default data directory
     * (to be consistent with seedblockchaind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
