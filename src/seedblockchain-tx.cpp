...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SeedBlockChain Core seedblockchain-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  seedblockchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded seedblockchain transaction") + "\n" +
                               "  seedblockchain-tx [options] -create [commands]   " + _("Create hex-encoded seedblockchain transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded seedblockchain transaction
