SeedBlockChain Core version 1.0.0 is now available from:

  <https://github.com/blockchainseed/seedblockchain/releases>

This is the initial version release, including various bug fixes and
performance improvements, as well as updated translations.

Please report bugs using the issue tracker at github:

  <https://github.com/blockchainseed/seedblockchain/issues>

Compatibility
==============

Seed Blockchain Core is extensively tested on multiple operating systems using
...
Seed Blockchain Core should also work on most other Unix-like systems but is not
...
Examples:
> seedblockchain-cli masternodestart "alias" "my_mn"
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "masternodestart", "params": ["alias" "my_mn"] }' -H 'content-type: text/plain;' http://127.0.0.1:5402/
```
...
Examples:
> seedblockchain-cli mnvote "local" "ed2f83cedee59a91406f5f47ec4d60bf5a7f9ee6293913c82976bd2d3a658041" "yes"
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "mnvote", "params": ["local" "ed2f83cedee59a91406f5f47ec4d60bf5a7f9ee6293913c82976bd2d3a658041" "yes"] }' -H 'content-type: text/plain;' http://127.0.0.1:5402/
```
...
[
  {
    ...
    "PaymentAddress": "xxxx",     (string) SeedBlockChain address of payment
...
Examples:
> seedblockchain-cli getbudgetprojection
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "getbudgetprojection", "params": [] }' -H 'content-type: text/plain;' http://127.0.0.1:5402/
```
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/seedblockchain-project-translations/).
