...
In order to support loading of multiple wallets in seedblockchain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is seedblockchain.cpp.
...
Changes to seedblockchain.cpp
----------------------
seedblockchain.cpp is the entry point into seedblockchain-qt, and as such, will require some minor modifications to provide hooks for
