...
* WebSocket: [https://github.com/SeedBlockChain-Project/insight-api-seedblockchain#web-socket-api](https://github.com/SeedBlockChain-Project/insight-api-seedblockchain#web-socket-api) 
* API: [https://github.com/SeedBlockChain-Project/insight-api-seedblockchain#swifttx-transactions](https://github.com/SeedBlockChain-Project/insight-api-seedblockchain#swifttx-transactions) 
...
By default, the SeedBlockChain Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SeedBlockChain Core daemon:
