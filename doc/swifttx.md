...
This mechanism has been integrated into Bitcore-Node-SeedBlockChain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/blockchainseed/seedblockchain/insight-api-seedblockchain#web-socket-api](https://github.com/blockchainseed/seedblockchain/insight-api-seedblockchain#web-socket-api) 
* API: [https://github.com/blockchainseed/seedblockchain/insight-api-seedblockchain#swifttx-transactions](https://github.com/blockchainseed/seedblockchain/insight-api-seedblockchain#swifttx-transactions) 
...
By default, the Seed Blockchain Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Seed Blockchain Core daemon:
